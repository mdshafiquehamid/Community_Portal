	...
	<form action=postjob method="post">
    	<table>
	    	<tr>
	    		...
	    		<td><input id="position" type="text" name="job_position" required></td>
	    	</tr>
	    	<tr>
	    		<td><label for="company">Company*</label></td>
	    		<td><input id="company" type="text" name="job_company" required></td>
	    	</tr>
	    	<tr>
	    		<td><label for="job_description">Job Description*</label></td>
	    		<td><textarea rows="10" cols="70" id="job_description" name="job_description" required></textarea></td>
	    	</tr>
	    	<tr>
	    		<td><label for="job_description">Job Requirements*</label></td>
	    		<td><textarea rows="10" cols="70" id="job_description" name="job_requirement" required></textarea></td>
	    	</tr>
    	</table>
