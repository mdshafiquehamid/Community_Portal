	...
	<form action=updateexperience method="post">
    	<table>
	    	<tr>
	    		...
	    		<td><input id="company" type="text" name="experience_company"></td>
	    	</tr>
	    	<tr>
	    		<td><label for="position">Job Position</label></td>
	    		<td><input id="position" type="text" name="experience_position"></td>
	    	</tr>
	    	<tr>
	    	...
	    	<tr>
	    		...
	    		<td><input id="country" type="text" name="experience_country"></td>
	    	</tr>
	    	<tr>
	    		<td><label for="experience_description">Description</label></td>
	    		<td><textarea rows="10" cols="70" id="experience_description" name="experience_description"></textarea></td>
	    	</tr>
    	</table>
