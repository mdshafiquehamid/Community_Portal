	...
	<form action=updatequalification method="post">
    	<table>
	    	<tr>
	    		...
	    		<td><input id="qualification_type" type="text" name="qualification_type"></td>
	    	</tr>
	    		<tr>
	    		<td><label for="qualification">Qualification</label></td>
	    		<td><input id="qualification" type="text" name="qualification_cert"></td>
	    	</tr>
	    	<tr>
	    		<td><label for="qualification_description">Description</label></td>
	    		<td><textarea rows="10" cols="70" id="qualification_description" name="qualification_description"></textarea></td>
	    	</tr>
    	</table>
