...
<div class="row messageboard-header">
	...
	<div class="col-sm-2">
		<a href="admincreatethread.action?submitType=new&email=<s:property value="#session.email" />">
	...
	<s:iterator value="threadlist">
		<tr class="table-light">
			<td class="thread_title">
				<a href="adminreplythread.action?submitType=list&thread_id=<s:property value="id" />&email=<s:property value="#session.email" />">
